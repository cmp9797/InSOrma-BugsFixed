...
public class ProfileActivity extends AppCompatActivity {
    ...
    TextView tvProfile, tvUsernameProfile, tvEmailProfile, tvPhoneProfile;
    Button btnEdit, btnDelete, btnLogout, btnSave, btnCancel;
    UserData userData;
...
//        setTitle("Hi " + userData.getLoggedIn().getUsername() + "!");
        ...
        tvProfile.setText("Hi " + userData.getLoggedIn().getUsername() + "!");
